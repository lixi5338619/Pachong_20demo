...
# url_five = "https://www.creditchina.gov.cn/api/record_param?encryStr={}&creditType=2&dataSource=0&pageNum=1&pageSize=10".format(encryStr)
# url_six = "https://www.creditchina.gov.cn/api/record_param?encryStr={}&creditType=4&dataSource=0&pageNum=1&pageSize=10".format(encryStr)
# url_seven = "https://www.creditchina.gov.cn/api/record_param?encryStr={}&creditType=8&dataSource=0&pageNum=1&pageSize=10".format(encryStr)
